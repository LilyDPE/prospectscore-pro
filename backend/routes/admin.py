    ...
    try:
        ...
        if debug:
            ...
            return {
                ...
                "type_local_values": df[type_local_col].value_counts().head(20).to_dict() if type_local_col else {"error": "colonne non trouvée"},
                "type_local_column_name": type_local_col
            }
